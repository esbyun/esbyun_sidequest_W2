...
let blob3 = {
  ...
  wobble: 16, // Edge deformation amount increased
  wobbleFreq: 2.9, //Frequency increased
  ...
  frictionGround: 0.99, // friction on ground lightened to give "Ice" effect
};
...
function setup() {
  ...
  platforms = [
    ...
    { x: 160, y: floorY3 - 195, w: 100, h: 12 }, // added platform
    { x: 50, y: floorY3 - 250, w: 90, h: 12 }, // added platform
    { x: 310, y: floorY3 - 260, w: 70, h: 12 }, // added platform
  ];
...
function draw() {
  background(148); // changed from light grey to dark grey

  // --- Draw all platforms ---
  fill(0, 0, 0); //changed from grey to black
...
function drawBlobCircle(b) {
  fill(184, 2, 2); // changed blob colour from blue to red
  beginShape();
